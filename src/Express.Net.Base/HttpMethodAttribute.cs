...
namespace Express.Net
{
    ...
    public class HttpGetAttribute : HttpMethodAttribute
    {
        public HttpGetAttribute(string? template = null)
            : base(Microsoft.AspNetCore.Http.HttpMethods.Get, template)
        {
    ...
    public class HttpPostAttribute : HttpMethodAttribute
    {
        public HttpPostAttribute(string? template = null)
            : base(Microsoft.AspNetCore.Http.HttpMethods.Post, template)
        {
    ...
    public class HttpDeleteAttribute : HttpMethodAttribute
    {
        public HttpDeleteAttribute(string? template = null)
            : base(Microsoft.AspNetCore.Http.HttpMethods.Delete, template)
        {
    ...
    public class HttpPutAttribute : HttpMethodAttribute
    {
        public HttpPutAttribute(string? template = null)
            : base(Microsoft.AspNetCore.Http.HttpMethods.Put, template)
        {
